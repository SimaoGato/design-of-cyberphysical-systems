...
public class Scheduler extends Thread {
	...
	/**
	 * Retrieves the next event in the queue, blocking if necessary.
	 * @return the next event in the input queue.
	 */
	public synchronized String getNextEvent() {
		try {
			return inputQueue.take();  // Blocks until an event is available
		} catch (InterruptedException e) {
			e.printStackTrace();
